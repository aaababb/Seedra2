...
import clock from '../../assets/Abdurahman/svg/clock.svg'
import grass from '../../assets/Abdurahman/svg/grass.svg'
import rasberry from '../../assets/Abdurahman/svg/rasberry.svg' 
import women from '../../assets/Abdurahman/svg/women.svg'
import berry from '../../assets/Abdurahman/svg/berry.svg'
import young from '../../assets/Abdurahman/svg/young.svg'
import arab from '../../assets/Abdurahman/svg/arab.svg'
  ...
  return (
    <div className='flex flex-col gap-[30px]'>
        <div className='flex gap-[30px]'>
            <div className='flex flex-col gap-[30px]'>
                <div className='w-[730px] h-[300px] rounded-lg bg-slate-200 flex'>
